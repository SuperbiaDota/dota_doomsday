...
LinkLuaModifier( "modifier_custom_rubick_telekinesis", "lua_abilities/custom_rubick_telekinesis/modifier_custom_rubick_telekinesis", LUA_MODIFIER_MOTION_NONE )
